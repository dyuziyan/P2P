...
/* ********  D E C O D I N G   M E T H O D S  ******** */
	...
	public static String getBASE64(String s,String charset) {
		if (s == null)
			return null;
		try {
			return org.apache.commons.codec.binary.Base64.encodeBase64String(s.getBytes(charset));
	...
	public static void main(String[] args) {
		System.out.println(getBASE64("aaaaaaaaaa","UTF-8"));
		System.out.println(getFromBASE64("YWFhYWFhYWFhYQ==","UTF-8"));
	}
