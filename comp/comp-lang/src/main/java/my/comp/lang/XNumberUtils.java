...
/**
 * @deprecated 使用{@link NumberUtils}
 * 
 *
 */
public class XNumberUtils extends org.apache.commons.lang.math.NumberUtils {

	public static BigDecimal min(BigDecimal... nums) {
		BigDecimal min = null;
		for (BigDecimal num : nums) {
			if (min == null || XNumberUtils.gt(min, num)) {
				min = num;
			}
		}
		return min;
	...
	public static void main(String[] args) {
		System.out.println(XNumberUtils.min(BigDecimal.ONE, BigDecimal.TEN, BigDecimal.ZERO));
	}
